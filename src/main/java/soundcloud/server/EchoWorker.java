...
public class EchoWorker implements Runnable {
	...
	private List<ServerSocketEvent> queue = new LinkedList<>();
	...
	public EchoWorker(Parser<EventEntity> sourceEventParser, Parser<String> clientEventParser,
	...
	public void newClient(ServerSocket server, SocketChannel socketChannel) {
		synchronized (queue) {
	...
	public void newMessage(ServerSocket server, SocketChannel socket, byte[] data, int count) {
